...
function Herobanner() {
  return (
    <div className="max-w-screen-2xl mx-auto w-full md:w-[80%]" >
      ...
      <div className="flex flex-col gap-4">
        <div className="relative flex justify-center">
          <img
            src="images/img2.png"
            alt="img1"
            className="absolute w-52 hidden md:block  left-0 top-[25%] z-10"
          />
          <img src="images/img1.png" alt="img1" className="w-[80%] z-20" />
          <img
            src="images/img3.png"
            alt="img1"
            className="absolute w-52 hidden md:block right-0 top-[25%] z-10"
          />
        </div>
